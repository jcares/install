...
function advanced_settings() {
  # Aquí puedes agregar la lógica para las configuraciones avanzadas si es necesario
}
...
qm create $VMID -tablet 0 -localtime 1 -cores $CORE_COUNT -memory $RAM_SIZE -name $HN \
  -tags proxmox-helper-scripts -net0 virtio,bridge=$BRG,macaddr=$MAC$VLAN$MTU $NET_CONFIG \
