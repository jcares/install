...
cd /opt/agendamedica/ || { echo "Error al entrar en el directorio bookmedic"; exit 1; }
...
source /opt/agendamedica/venv/bin/activate
...
# Finalización
echo "Instalación completada. Para activar Agenda Medica, usa 'source /opt/agendamedica/venv/bin/activate' y luego ejecuta el script correspondiente."
